...
npm test                       # Frontend tests (403 tests across 50 test suites)
.venv\Scripts\python.exe -m pytest backend\tests -v   # Backend tests (528 tests across 25 suites — see docs/TESTING.md for the per-suite inventory)
```
