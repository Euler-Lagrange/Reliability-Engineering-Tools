...
export const THEME_REGISTRY: readonly ThemeRegistryEntry[] = [
  ...
  },
  {
    ...
    shortLabel: "Kraft",
    icon: NotePencil,
    description: "Warm paper and graphite. Workshop notebook aesthetic.",
    scheme: "light",
    inRail: false,
  },
  {
    ...
    shortLabel: "Forest",
    icon: TreeEvergreen,
    description: "Deep pine and moss. Biophilic dark theme for long runs.",
    scheme: "dark",
    inRail: false,
  },
  {
    ...
    shortLabel: "Dawn",
    icon: Compass,
    description: "Soft charcoal on warm ivory. Newsprint precision.",
    scheme: "light",
    inRail: false,
  },
];
